...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1003437775732"))
...
DB_NAME = os.environ.get("DATABASE_NAME", "tesstfilesharexbot")
...
#start message
START_PIC = os.environ.get("START_PIC","https://files.catbox.moe/wqqs1b.jpg")
